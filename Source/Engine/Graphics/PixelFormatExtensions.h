...
namespace DawnEngine
{
    ...
    public:
        ...
        /*static int32 SizeInBytes(const PixelFormat format)
        {
        ...
        //static int32 SizeInBits(PixelFormat format);
        ...
        /// <param name="format">The pixel format</param>
        /// <returns>The size in bits</returns>
        // static int32 AlphaSizeInBits(PixelFormat format);
        ...
        //static int ComputeScanlineCount(PixelFormat format, int32 height);
